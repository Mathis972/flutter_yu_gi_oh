...
class CardListDetailsSetWidget extends StatefulWidget {
   const CardListDetailsSetWidget({Key? key, required this.name}) : super(key: key);

   final String name;

  @override
  State<CardListDetailsSetWidget> createState() => _CardListDetailsSetWidgetState();
}
...
class _CardListDetailsSetWidgetState extends State<CardListDetailsSetWidget> {
  ...
  Future<void> getCard() async {
    ...
    final response = await http.get(Uri.parse("$url/cardinfo.php?language=fr&cardset=" + nameSetEncode));
